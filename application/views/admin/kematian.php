				   ...
				   <div class="col-12">
					   <div class="card">
						   <div class="card-body">
							   ...
							   <h2>Daftar Dokumen Akta Kematian</h2>
											...
											$no=1;
											  ...
											  $rt    = $nama['nomor_rt'];
											   ?>
													...
													<td><?= $rt ?></td>
													<td><?= $rw ?></td>
													<td><a class="btn btn-info" href="<?php echo base_url();?>./kematian/<?= $p->akte_nikah;?> ">Download Akta </a> </td>

													<td><a class="btn btn-info" href="<?php echo base_url();?>./kematian/<?= $p->ktp;?> ">Download KTP  </a> </td>
													<td><a class="btn btn-info" href="<?php echo base_url();?>./kematian/<?= $p->kk;?> ">Download KK</a> </td>
													<td><a class="btn btn-info" href="<?php echo base_url();?>./kematian/<?= $p->ktppel;?> ">Download KTP Pelapor </a> </td>
