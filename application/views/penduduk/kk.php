            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <div class="card-body">
                    <h4 class="card-title">Pengunggahan Dokumen Kartu Keluarga (KK)</h4>
                    <p class="card-description"> Upload Data Sesuai Petunjuk </p>
                    <form class="forms-sample" enctype="multipart/form-data" action="<?php echo base_url(). 'Kk/tambah'; ?>" method="post">
		...
		<div class="form-group">
                  ...
                  <label for="exampleInputUsername1">RT</label>
                    ...
                    <select name="rt" required="true" class="form-control">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Foto Akta Kelahiran</label>
						<p>file berupa pdf, doc, docx</p>
                        <input type="file" class="form-control" name="akta"  required>
                      </div>
					  <div class="form-group">
                        <label for="exampleInputPassword1"> Upload Formulir Biodata</label>
						<p>file berupa pdf, doc, docx</p>
